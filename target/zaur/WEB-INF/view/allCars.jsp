...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <button class="btn btn-sort" onclick="window.location.href = 'carsSortByYear'">сортировать по дате</button>
      <button class="btn btn-default" onclick="window.location.href = 'carsSortByModel'">сортировать по модели</button>
    </div>
  </div>
  <!-- /.row -->
